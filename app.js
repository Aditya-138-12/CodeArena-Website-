...
document.addEventListener('DOMContentLoaded', () => {
	...
	window.addEventListener('scroll', ()=> {
		...
		let parallaxOffset = scroll_posVW * -0.3;
...
let stopWatch;
const main_div_1 = document.getElementsByClassName("main_div_1")[0];
main_div_1.addEventListener('mousemove', (e) => {
	
	clearTimeout(stopWatch);
	document.getElementById("stylish_p").style.animation = "2s tubelight linear infinite";
	stopWatch = setTimeout(() => {
		document.getElementById("stylish_p").style.animation = "none";
	}, 100);
...
document.addEventListener('wheel', (e) => {
	...
	else if(e.deltaY < 0){console.log("Scrolling up");}
});
